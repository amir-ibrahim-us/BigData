...
public class KaftaTwitterStream {
    private static final String topic = "money";
    public static void run() throws InterruptedException {
        Properties properties = new Properties();
        properties.put("metadata.broker.list", "sandbox.hortonworks.com:9092");
        ...
        endpoint.trackTerms(Lists.newArrayList("love", "#life",
                "#anniversary"));
